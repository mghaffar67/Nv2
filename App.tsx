...
// Sub-pages using standard relative paths
import ModuleManager from './pages/admin/advanced/ModuleManager';
import CMSEditor from './pages/admin/advanced/CMSEditor';
import CampaignManager from './pages/admin/advanced/CampaignManager';
import IntegrationHub from './pages/admin/advanced/IntegrationHub';

// Settings Identity Nodes
        ...
        <MaintenanceGuard>
          ...
          <Routes>
            ...
            <Route path="/user" element={
              ...
              <Route path="work/:category" element={<DailyWork />} />
            ...
            <Route path="/admin" element={
              ...
              <Route path="advanced" element={<AdvancedLayout />}>
                 ...
                 <Route path="content" element={<CMSEditor />} />
